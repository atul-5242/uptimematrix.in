        ...
        <CardContent>
          <div className="grid gap-6 md:grid-cols-3">
            <div className="flex flex-col items-center text-center space-y-3 p-4 rounded-lg border-2 border-dashed border-muted-foreground/25">
              ...
              <h3 className="font-semibold">Add Your First Monitor</h3>
              <p className="text-sm text-muted-foreground">Monitor a website, API endpoint, or server to get started</p>
            ...
            <div className="flex flex-col items-center text-center space-y-3 p-4 rounded-lg border-2 border-dashed border-muted-foreground/25">
              ...
              <p className="text-sm text-muted-foreground">Configure email, SMS, or Slack alerts for when issues occur</p>
            ...
            <div className="flex flex-col items-center text-center space-y-3 p-4 rounded-lg border-2 border-dashed border-muted-foreground/25">
              ...
              <p className="text-sm text-muted-foreground">Build a public status page to keep your users informed</p>
              <Button variant="outline" className="mt-2">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Email, SMS, Slack, Discord, and 20+ integrations</p>
              </div>
            </div>
