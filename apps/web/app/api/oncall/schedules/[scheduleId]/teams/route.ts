...
export async function POST(req: NextRequest, { params }: { params: { scheduleId: string } }) {
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/api/oncall/schedules/${scheduleId}/teams`, {
      method: 'POST',
      headers: {
    ...
    console.error(`Error proxying POST /api/oncall/schedules/${scheduleId}/teams:`, error);
